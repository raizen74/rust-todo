...
async fn index() -> HttpResponse {
    HttpResponse::Ok()
        ...
        .body(include_str!("../index.html")) // macro embeds the contents of the file as a string
}

#[derive(RustEmbed)]
#[folder = "../frontend/public"] // relative path from workspace root to the folder containing the frontend assets
